        ...
        try {
            ...
            if (!parametri.containsKey("unita1") || 
                ...
                inviaErrore(exchange, 400, 
                    "Parametri mancanti. Necessari: unita1, unita2, valore");
                return;
            }
            ...
            // Esegue il calcolo
            double risultato = ConversioneService.converti(unita1, unita2, valore);
            ...
            inviaErrore(exchange, 400, "Unita non validi. Devono essere numeri");
